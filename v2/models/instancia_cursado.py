...
class InstanciaCursado(SQLModel, table=True):
    ...
    fecha_inicio: Optional[datetime] = Field(default=None, description="Fecha de inicio del cursado")
    fecha_fin: Optional[datetime] = Field(default=None, description="Fecha de fin del cursado")
