...
class PeriodoInscripcionMateria(SQLModel, table=True):
    ...
    programa_id: int = Field(foreign_key="programa.id", index=True, description="Programa al que aplica")
    ...
    fecha_inicio: datetime = Field(index=True, description="Inicio del periodo de inscripción")
    fecha_fin: datetime = Field(index=True, description="Fin del periodo de inscripción")
